...
I noticed that _∆fur_ stalled earlier than the other strains. It’s not necessarily a problem, but I’d like to understand the cause. The paper should also explain this, so we’ll need the rationale anyway.
